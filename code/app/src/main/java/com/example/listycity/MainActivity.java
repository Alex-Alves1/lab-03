...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Adapted from Google Gemini queries, when seeing how to set up
        //a on click listener for editing city and integrating with rest of code.
        cityList.setOnItemClickListener((adapterView, view, i, l) -> {
            City cityToEdit = dataList.get(i);
